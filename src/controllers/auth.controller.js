...
const getUsers = async (req, res, next) => {
    try {
        ...
        const response = await pool.query(`SELECT id_user, created::text, modified::text, username, email, type, id_company FROM public.user ${filters} ORDER BY id_user 
...
const getUserId = async (req, res, next) => {
    try {
        ...
        const response = await pool.query('SELECT id_user, created::text, modified:text, username, email, type, id_company FROM public.user WHERE id_user = $1', [id]);
