...
const { getDocuments, getDocumentById, createDocument, 
    updateDocument, deleteDocument, getDocumentByFilters, getDocumentCustomers, getDocumentByFilters1, updateApiDocument } = require('../controllers/documents.controllers');
