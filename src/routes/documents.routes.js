...
const { getDocuments, getDocumentById, createDocument, 
    updateDocument, deleteDocument, getDocumentByFilters, getDocumentCustomers, getDocumentByFilters1, updateApiDocument, clearDocuments, createApiDocument } = require('../controllers/documents.controllers');
