...
const { getAuditReportData, formatWhatsAppReport, sendWhatsAppAuditReport, getWhatsAppRecipientPhone } = require('../../../src/libs/report.libs');
exports.reportCommand = new commander_1.Command('report')
    ...
    try {
        ...
        if (companiesToShow.length === 0) {
            ...
            const tableData = companiesToShow.map((c) => ({
        ...
        if (options.markdown) {
            ...
            fs_1.default.writeFileSync(filepath, md, 'utf-8');
